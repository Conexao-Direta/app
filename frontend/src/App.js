    ...
    const theme = createTheme({
          ...
          // },
                ...
                "&::-webkit-scrollbar-thumb": {
                    backgroundColor: mode === "light" ? "#1E9C08" : "#003366",
					borderRadius: "8px",
                },
            },
            palette: {
                type: mode,
                // Cor primária: verde claro no modo claro, azul escuro no modo escuro
                primary: { main: mode === "light" ? "#1E9C08" : "#135C03" }, // Azul claro e escuro
                // Cor para o botão de sair: azul claro no modo claro, azul escuro no modo escuro
                sair: { main: mode === "light" ? "#F50000" : "#6E0101" },
                // Cor do cartão de visita: azul claro no modo claro, azul escuro no modo escuro
                vcard: { main: mode === "light" ? "#1E9C08" : "#135C03" },
                // Cor do texto principal: azul claro no modo claro, branco no modo escuro
                textPrimary: mode === "light" ? "#1E9C08" : "#FFFFFF",
                // Cor da borda principal: azul claro no modo claro, branco no modo escuro
                borderPrimary: mode === "light" ? "#1E9C08" : "#FFFFFF",
