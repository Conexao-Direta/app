...
const useStyles = makeStyles((theme) => ({
  ...
  redBox: {
    backgroundColor: "#fafafa", // Definindo a cor de fundo vermelha
    ...
    <MainContainer>
      ...
      <Paper className={classes.redBox} variant="outlined">
        <Typography variant="body1">
          <strong>Aviso Importante:</strong> Informamos aos usuários da Conexão Direta que a interrupção no funcionamento do OpenAI não é um erro do sistema. O OpenAI oferece um crédito gratuito de $5 USD para novos cadastros, com validade de cerca de três meses. Após o esgotamento do crédito, é necessário recarregar a conta para continuar usando o serviço. Caso o serviço tenha sido interrompido, verifique a expiração do crédito e, se necessário, realize a recarga. Estamos à disposição para esclarecer dúvidas e agradecemos pela compreensão.
        </Typography>
        {/* Links úteis */}
        <Typography variant="body1">
